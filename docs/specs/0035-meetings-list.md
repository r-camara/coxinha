# Spec 0035: Meetings list view

- **Status:** in-progress
- **Phase:** F1
- **Owner:** Rodolfo
- **Depends on:** spec 0006 (recording), spec 0007 (transcription), spec 0009 (summarization)
- **Relevant ADRs:** —
...
- **Empty state** when no meetings yet, with a CTA pointing at
  call detection (spec 0005) and the manual recording shortcut
